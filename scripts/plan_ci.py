...
GROUP_TEST_MODULES = {
    ...
    "vulkan-v0-b": [
        ...
        "test_v1a_execution_participant",
        "test_v1a_runner",
        "test_v1a_vulkan_adapter",
        "test_v1a_evidence_manifest",
        "test_v1b_campaign",
        "test_v1b_evidence_manifest",
        "test_v1c_accounting",
        "test_v1c_runner",
        "test_v1c_evidence_manifest",
        "test_v2a_discovery",
        "test_v2a_authority",
        "test_v2a_harness",
...
PATH_GROUPS = {
    ...
    # Issue #168 Arm-C post-SWA requalification blocked record (CPU-only
    # pre-observation terminal; no physical execution).
    "docs/implementation/r6-successor-arm-c-requal-blocked-168/": ["issue-117-133"],
    "scripts/issue168_corpus_census.py": ["issue-117-133"],
    ...
    "scripts/issue241_host_producer.py": ["vulkan-v0-b"],
    "scripts/issue241_placement_producer.py": ["vulkan-v0-b"],
    "scripts/issue241_comparator_producer.py": ["vulkan-v0-b"],
    "tests/test_issue241_host_producer.py": ["vulkan-v0-b"],
    "tests/test_issue241_placement_producer.py": ["vulkan-v0-b"],
    "tests/test_issue241_comparator_producer.py": ["vulkan-v0-b"],
    "tests/test_issue241_physical_producer.py": ["vulkan-v0-b"],
    "tests/test_issue241_measured_practicality.py": ["vulkan-v0-b"],
