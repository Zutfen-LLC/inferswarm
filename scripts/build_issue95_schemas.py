...
SCHEMAS = ROOT / "docs/qualification/gemma4-12b-it-v4/schemas"
BASE = "https://inferswarm.dev/schema/issue95/"
CONTRACT = "inferswarm.gemma4-prediction-aligned-qualification/1"
...
def build() -> dict[str, dict]:
    ...
    schemas["calibration-corpus.schema.json"] = schema(
        ...
        {
            "schema": {"const": "inferswarm.issue95.v4-calibration-corpus/1"},
            "contract_id": {"const": CONTRACT},
            "generator": {"const": "scripts/generate_issue95_corpora.py"},
            "generator_sha256": SHA,
            "tokenizer": tokenizer_block(),
            "seed": {"const": "inferswarm-issue-95-calibration-v4-2"},
            "cases_per_cell": {"const": 79},
            "cases": {"type": "array", "minItems": 1896, "maxItems": 1896, "items": case_ref()},
    ...
    schemas["stress-pool.schema.json"] = schema(
        ...
        {
            "schema": {"const": "inferswarm.issue95.v4-stress-pool/1"},
            "contract_id": {"const": CONTRACT},
            "generator": {"const": "scripts/generate_issue95_corpora.py"},
            "generator_sha256": SHA,
            "tokenizer": tokenizer_block(),
            "seed": {"const": "inferswarm-issue-95-stress-pool-v4"},
    ...
    schemas["selected-stress-eighth.schema.json"] = schema(
        ...
        {
            "schema": {"const": "inferswarm.issue95.v4-selected-stress-eighth/1"},
            "contract_id": {"const": CONTRACT},
    ...
    schemas["decision-domain-manifest.schema.json"] = schema(
        ...
        {
            "schema": {"const": "inferswarm.issue95.v4-decision-domain-manifest/1"},
            "contract_id": {"const": CONTRACT},
            ...
            "statistical_cases": {
                "type": "array", "minItems": 1896, "maxItems": 1896,
                "items": {
                    "type": "object",
                    "additionalProperties": False,
    ...
    schemas["calibration-summary.schema.json"] = schema(
        ...
        {
            "schema": {"const": "inferswarm.issue95.v4-calibration-summary/1"},
            "contract_id": {"const": CONTRACT},
            ...
            "statistical_cases": {"type": "array", "minItems": 1896, "maxItems": 1896, "items": summary_case_row},
    ...
    schemas["sealed-holdout-commitment.schema.json"] = schema(
        ...
        {
            "schema": {"const": "inferswarm.issue95.v4-holdout-commitment/1"},
            "contract_id": {"const": CONTRACT},
            ...
            "cells": {
                ...
                "items": {
                    ...
                    "properties": {
                        "case_id": {"type": "string", "pattern": "^h95-"},
                        "content_class": {"type": "string"},
                        "length_regime": {"type": "array", "items": {"type": "integer"}, "minItems": 2, "maxItems": 2},
                        "token_count": {"type": "integer"},
                        "prompt_sha256": SHA,
    ...
    schemas["holdout-custody-record.schema.json"] = schema(
        ...
        {
            "schema": {"const": "inferswarm.issue95.v4-holdout-custody-record/1"},
            "contract_id": {"const": CONTRACT},
            "custodians": {
