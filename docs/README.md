...
| add, retain, or retire a CI test module | [Test lifecycle](ci-impact-planning.md#test-lifecycle-issue-246), the [retention audit](ci/test-retention-audit.json), and the [retired-test-row tombstones](ci/retired-test-rows.json) |
