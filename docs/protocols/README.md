...
- Arm C executed 2026-09-09 from accepted main fed87d1b71a0794374dd58c921e31606a56a242f: the campaign is methodology/evidence-blocked (ISSUE117_ARM_C_EVIDENCE_BLOCKER, post-correctness-bearing methodology / evidence-admissibility failure). The frozen pre-execution authority (5e2c83a) binds the single-shot direct comparator; the driver and reducer were modified after correctness-bearing execution (disclosed in evidence/arm-c/pre-execution-authority-audit.json). armc-direct-6 (invalid, 24 correctness-bearing results, frozen invocation) triggered the mandatory §10 stop; armc-direct-7/8/9 and armc-ordinary-1 are post-stop diagnostic observations. The retained 18/24 comparison and six regime-4 divergences are diagnostic evidence for a follow-up hypothesis, not an accepted FAIL. Four tokenizer-metadata /srv/models/ reads are retained and counted under the frozen zero-Source rule. No ordinary-serving semantic PASS or FAIL exists from this campaign.
