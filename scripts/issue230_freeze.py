#!/usr/bin/env python3
"""Issue #230 — V2-F fail-closed producer freeze.

Identical corrected semantics to the accepted #228 closure (schema /1):
...
SCHEMA_CLOSURE = "inferswarm.v2f.producer-closure/1"
...
# Same semantics as the accepted #228/#216 protocol: a reduction-layer
# correction AFTER retained physical output does not invalidate the
# evidence; an AMENDMENTS.json entry proves the collectors' executed
# bytes are unchanged, mechanically per entry, fail-closed.

AMENDMENT_SCHEMA = "inferswarm.v2f.producer-amendments/1"
