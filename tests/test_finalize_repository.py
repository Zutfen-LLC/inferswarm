...
class MigrationContractTests(unittest.TestCase):
    ...
    def test_registry_order_and_kinds(self) -> None:
        ...
        self.assertLess(order.index("issue137-bundle-verify"),
                        order.index("issue189-terminal"))
        self.assertLess(order.index("issue189-terminal"),
                        order.index("issue189-producer-hashes"))
        self.assertLess(order.index("issue189-manifest"),
        ...
        self.assertLess(order.index("issue209-manifest"),
                        order.index("issue222-terminal"))
        self.assertLess(order.index("issue222-terminal"),
                        order.index("issue222-producer-hashes"))
        self.assertEqual(order[-1], "issue222-manifest")
