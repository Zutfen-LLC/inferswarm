...
STAGE = ROOT / "docs/investigations" / NS / "final-boot-staging"
...
def build(die: str, selector: str, cu: str, mr: str, impl: str, bdf: str) -> dict:
    ...
    return {
        ...
        "discovery_binding": {
            ...
            "bindings_path": f"docs/investigations/{NS}/final-boot-staging/discovery/DISCOVERY-BINDINGS-R3.json",
            ...
            "inventory_path": f"docs/investigations/{NS}/final-boot-staging/discovery/DISCOVERY-INVENTORY-R3.json",
...
if __name__ == "__main__":
    ...
    for die, kw in dies.items():
        doc = build(die, **kw)
        out = AREA / f"AUTHORITY-V2C-FINAL-{die.upper()}.json"
