...
EVIDENCE_FILES = frozenset({
    ...
    "evidence/v0c-r2-plan/candidate-set.json",
    ...
    "raw/v0c-amd-a-final-qualification-02/attempt.json",
    "raw/v0c-amd-a-final-qualification-02/exit-code.txt",
    "raw/v0c-amd-a-final-qualification-02/stderr.txt",
    "raw/v0c-amd-a-final-qualification-02/stdout.txt",
    "raw/v0c-amd-a-final-canonical-02/attempt.json",
    "raw/v0c-amd-a-final-canonical-02/exit-code.txt",
    "raw/v0c-amd-a-final-canonical-02/stderr.txt",
    "raw/v0c-amd-a-final-canonical-02/stdout.txt",
})
SOURCES = frozenset({
