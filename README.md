...
- **Recorded execution authorization:** blocked — Issue #172 executed the physical Arm-C requalification ISSUE117_ARM_C_ORDINARY_SERVING_PASS (campaign issue172-arm-c-requalification-v1, attempt armc-requal172-physical-1, PR open/unmerged for maintainer review): on producer 6202eee (accepted #166 remediation bytes verified on every participant) the 40-case canonical campaign (accepted 24-case #133 regression fixture + accepted #170 16-case long-remainder corpus consumed without regeneration) is 40/40 exact direct-vs-ordinary on committed ids, stopping, decoded bytes, and the per-call invocation seam; all seven sentinels are 6/6 deterministic within each arm and exact across arms; all fencing/Coordinator/Source/SWA invariants hold; SWA ownership observed through the accepted #166 pure-read seam. The historical #133 FAIL is preserved as the correct result of the pre-remediation campaign; this PASS does not rewrite it. Arm D/E remain blocked pending maintainer acceptance/merge of this requalification..
