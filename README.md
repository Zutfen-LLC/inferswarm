...
- **Recorded execution authorization:** blocked — Issue #170 froze the prospective Arm-C long-remainder public generalization corpus with ISSUE117_ARM_C_LONG_REMAINDER_CORPUS_FROZEN (CPU-only, PR open for maintainer review): 16 new public g170-* cases, exact target rendered lengths 65..128, exactly four cases per original second-chunk-remainder bucket, all six accepted content classes at least twice, disjoint from all public historical identities. No physical execution; no h109 access; no Arm-C verdict; Arm D/E remain blocked. The physical Arm-C requalification successor (40-case canonical campaign: accepted 24-case #133 fixture + this 16-case corpus) remains separately blocked pending maintainer acceptance/merge of the corpus freeze..
